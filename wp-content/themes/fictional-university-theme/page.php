...
<?php
    ...
    $childsArray = get_pages(array(
        'child_of' => get_the_ID(),
    ));
    if ($theParent or $childsArray) {
  ...
  <?php }?>
    ...
    <form method="get">
      <input type="text" name="skyColor" id="skyColor" placeholder="skyColor">
      <input type="text" name="grassColor" id="grassColor" placeholder="grassColor">
