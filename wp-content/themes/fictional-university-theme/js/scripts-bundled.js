  ...
  _createClass(Search, [{
    ...
    value: function getResults() {
      ...
      _jquery.default.getJSON(universityData.root_url + '/wp-json/university/v1/search?term=' + this.searchField.val(), function (results) {
        ...
        }).join(''), "\n                        ").concat(results.professors.length ? "</ul>" : '', "\n                    </div>\n                    <div class=\"one-third\">\n                        <h2 class=\"search-overlay__section-title\">Campuses</h2>\n                        ").concat(results.campuses.length ? "<ul class=\"link-list min-list\">" : "<div>No campuses match your search. <a href=\"".concat(universityData.root_url + '/campuses', "\">View all campuses</a></div>"), "\n                        ").concat(results.campuses.map(function (item) {
          return "<li><a href=\"".concat(item.permalink, "\">").concat(item.title, "</a></li>");
        }).join(''), "\n                        ").concat(results.campuses.length ? "</ul>" : '', "\n                        <h2 class=\"search-overlay__section-title\">Events</h2>\n                        ").concat(results.events.length ? '' : "<div>No events match your search. <a href=\"".concat(universityData.root_url + '/events', "\">View all events</a></div>"), "\n                        ").concat(results.events.map(function (item) {
...
function () {
  ...
  _createClass(Like, [{
    key: "events",
    value: function events() {
      (0, _jquery.default)(".like-box").on("click", this.clickLikeDispatcher.bind(this));
    } // methods

  }, {
    key: "clickLikeDispatcher",
